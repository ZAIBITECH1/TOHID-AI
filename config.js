...
const defaultOwner = '923039833847';


// Check for the OWNERS environment variable; if not found, use the default
const ownervb = process.env.OWNERS || process.env.OWNER_NUMBER || '923039833847' ; // put your number here
...
global.pairingNumber = process.env.BOT_NUMBER || '923039833847' ;  // put your number here
global.SESSION_ID = process.env.SESSION_ID || '' ;  // put your session id here

global.mods = []
global.prems = []
global.allowed = ['923039833847', '923116798238']
